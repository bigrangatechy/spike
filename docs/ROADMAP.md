...
├── Governance model defined (GOVERNANCE.md — to be written)
...
│   ├── DCO (no CLA)
│   └── Monorepo structure
└── Branding identity established (BRANDING.md — to be written)
...
│   ├── Network detection (Wi-Fi, Ethernet, firmware)
│   ├── Bluetooth detection
│   └── Modem detection
...
Note: The 18-month target assumes alpha starts promptly after
documentation is complete. The pre-alpha duration is intentionally
unbounded — rushing documentation compromises the docs-first
methodology and the "built to outlast" principle.
...
──────────────────────────────────────────────────────────────────────────────
Ubuntu 26.04 LTS release                Scheduled Apr 2026  Spike targets this kernel;
                                                            fallback: 24.04 LTS
...
What This Document Does Not Cover
    ...
    Governance and decision-making authority: See GOVERNANCE.md (to be written)
    End-of-life policy for releases: See END-OF-LIFE-POLICY.md (to be written)
    Contribution guidelines and workflow: See CONTRIBUTING.md (to be written)
    Code of conduct: See CODE_OF_CONDUCT.md (to be written)
    Release process (signing, publishing): See dev-guide/17-release-process.md (to be written)
    Performance targets: See PERFORMANCE-BASELINES.md
    Hardware tier definitions: See HARDWARE.md (to be written)
