...
All support channels operate under the Spike Code of Conduct (see `CODE\_OF\_CONDUCT.md` for the full text).
...
- **Code of Conduct full text:** See `CODE\_OF\_CONDUCT.md` 
