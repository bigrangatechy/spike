...
These constraints are structural — they define what Spike IS.
Changing them creates a different project, not a new version of Spike.
...
──────────────────────────────────────────────────────────────────────────
Community Member      Anyone who uses Spike or             Join the forum or Matrix
                      participates in discussions          (no special access)

Reporter              Submits bug reports or              Open a quality issue with
                      feature suggestions                  reproduction steps

Contributor           Submits code or documentation        One merged merge request
                      that is accepted                     (DCO required)

Trusted Contributor   Consistently high-quality           5+ merged MRs, trusted
                      contributions, given merge          by BDFL, no broken merges
                      access to specific areas

Reviewer              Can review MRs in specific areas    Trusted Contributor +
                      (cannot merge to main)              demonstrated review skill

Maintainer            Can merge to main in specific       BDFL appointment
                      areas (not all areas)
...
A fork that violates trademark terms will be asked to rebrand.
Persistent violation may result in legal action (last resort only).
