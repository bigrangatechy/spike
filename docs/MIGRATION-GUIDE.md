...
This is the most important step. Installing Spike will erase
everything on the target drive. There is no undo.
...
2. Spike automatically detects it and shows a notification:
   "USB drive connected. Open in Files?"
