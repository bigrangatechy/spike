...
```
`├── Qt font scaling: QT\_FONT\_DPI adjusted (96 \* scale factor)`
...
```
`├── Spike Shell: configuration flag "simplified\_mode": true`
...
- **Code of conduct (community accessibility):** See `CODE\_OF\_CONDUCT.md` 
