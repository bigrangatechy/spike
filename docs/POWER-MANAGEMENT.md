...
Range: 0-100% (hardware-dependent minimum)
Minimum safe: 10% (below this, LCD may not turn on)
...
Recommendation shown: "Blanking the screen uses less power than
a screensaver. We recommend keeping screensaver off for better
battery life."
...
⚠️ Warning shown: "Aggressive spin-down may cause HDD wear.
Frequent spin-up/spin cycles stress the drive. If you hear the
drive frequently starting and stopping, increase the timeout."
...
Purpose: Limit max charge to extend battery lifespan
(100% charge stresses lithium-ion cells)
