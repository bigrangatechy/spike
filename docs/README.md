...
See [HARDWARE.md](https://lumo.proton.me/HARDWARE.md) for the complete hardware specification, detection logic, and tier classification.
...
See [ROADMAP.md](https://lumo.proton.me/ROADMAP.md) for the complete development timeline.  
See [CHANGELOG.md](https://lumo.proton.me/CHANGELOG.md) for what has been done so far.
...
| License | GPLv2+ (code), CC BY-SA 4.0 (branding assets) |
...
See [PHILOSOPHY.md](https://lumo.proton.me/PHILOSOPHY.md) for the full value system.  
See [GOVERNANCE.md](https://lumo.proton.me/GOVERNANCE.md) for structural constraint override process.
