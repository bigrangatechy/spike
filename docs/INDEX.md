...
`│   ├── Want to contribute → CONTRIBUTING.md → AGENTS.md → CODE\_OF\_CONDUCT.md`
...
| ✅ | `CODE\_OF\_CONDUCT.md` | Community behavior standards and enforcement model |
...
`└── (referenced by: CODE\_OF\_CONDUCT.md, CONTRIBUTING.md, BRANDING.md)`
```
...
```
`├── → CODE\_OF\_CONDUCT.md, AGENTS.md, GOVERNANCE.md, ARCHITECTURE.md,`

`│      DESIGN-DECISIONS.md, SUPPORT.md, SECURITY.md, PRIVACY.md,`

`│      ROADMAP.md, PHILOSOPHY.md`

`└── (referenced by: README.md, SUPPORT.md, CODE\_OF\_CONDUCT.md)`
```

`SUPPORT.md`

```
`├── → CODE\_OF\_CONDUCT.md, CONTRIBUTING.md, FAQ.md, TROUBLESHOOTING.md,`
