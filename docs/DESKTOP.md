...
Reason: The transient hint only affects display behavior, not persistence.
If a user heard a notification sound, they should be able to find it.
...
One content source, three presentation layers.
Changes to the Markdown files propagate everywhere.
