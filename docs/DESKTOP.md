...
When an application sends a notification with the `replaces\_id` parameter, indicating it replaces a previous notification:
...
`│   ├── Tray badge restored from last\_read\_id`
