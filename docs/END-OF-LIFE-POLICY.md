...
Settings → Software Updates → "Upgrade Spike" (in-place upgrade):
...
- Upgrade technical details (apt mechanics, Flatpak updates): See `SECURITY.md` 

- Migration guide for specific version transitions: See `MIGRATION-GUIDE.md` 
