...
VERSION="${SPIKE_SHELL_VERSION:-0.0.14}"
...
Recommends: kwin-wayland, xwayland, dbus-user-session, seatd, libseat1, breeze-cursor-theme, breeze-icon-theme, spike-config, libkf6kcmutils-bin, pulseaudio-utils, upower
