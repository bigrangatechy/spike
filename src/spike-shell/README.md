...
| Lock screen | ✅ `SpikeLockScreen` + PAM + breeze LNF `LockScreen.qml` for KWin greeter |
| Home seed | ✅ `spike-seed-home` (XDG dirs, Mozilla, LibreOffice) |
...
# → build/packages/spike-shell_0.0.35-1_amd64.deb
```
